...
public class Availability_Bush {
    ...
    /**/
        ...
        public void v_create_availability_halls() throws SQLException {
            String sql99 = "DROP TABLE IF EXISTS availability_halls_bush_house";
            String sql87 =
                            "CREATE TABLE `availability_halls_bush_house` (\n" +
                           "  `hour` int NOT NULL,\n" +
                           "  `hall` varchar(10) NOT NULL,\n" +
                           "  `available` int DEFAULT NULL,\n" +
                           "  PRIMARY KEY (`hour`,`hall`),\n" +
                           "  CONSTRAINT `availability_halls_bush_house_ibfk_1` FOREIGN KEY (`hour`) REFERENCES `timeslots` (`Hour`)\n" +
                           ") ";
